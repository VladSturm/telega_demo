...
import { setMessagesWork } from '../../stores/actions'
...
function ChatWindow({ dialog }) {
    ...
    let messagesWork = useSelector(state => state.dialogesData.messagesWork)
    const dispatch = useDispatch()
    console.log(messagesWork)
    ...
    const getMessageInStore = () => {
        ...
        let newMessagesWork = update(messagesWork, {$push: [data]})
        dispatch(setMessagesWork(newMessagesWork))       
        setInputValue()
    }
